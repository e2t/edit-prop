...
Public Const pMassLbs = "Масса LBS"
...
Function Init() As Boolean
    ...
    AppendPaperSize "A4 гориз *", "A4", 0.297, 0.21
        ...
        For Each J In I
            ...
            If Not CheckIsStandardScale(AScale(0), AScale(1)) Then
                MainForm.labWarningSelected.Caption = _
                    "НЕСТАНДАРТНЫЙ МАСШТАБ """ & AView.Name & """ " & Str(AScale(0)) & ":" & Str(AScale(1))
...
Function OpenSettingsFile() As Boolean
    ...
    DrawingCodes(1) = ".ID=Монтажный чертеж,Installation Drawing,Монтажний кресленик,Montavimo brezinys"
