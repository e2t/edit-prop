...
Private Sub ConfBox_Change()
  ...
  If gItems.Exists(gCurConf) Then 'çàïèñü ñòàðîé êîíôèãóðàöèè
    ReadForm gCurConf
  End If

  gCurConf = ConfBox.Text  'äî ýòîãî â gCurConf çàïèñàíà ñòàðàÿ êîíôèãóðàöèÿ
  
  If Not gItems.Exists(gCurConf) Then
    gModel.ShowConfiguration2 gCurConf 'óñêîðÿåò ÷òåíèå ñâîéñòâ
...
Private Sub CloseBut_Click()
  ...
  If IsShiftPressed Then
    gDoc.Save3 Options, Errors, Warnings  ' îòñóòñòâóåò ïðîâåðêà ñîõðàíåíèÿ
