...
- Добавлены поля для наименований на польском, английском и украинском языках. Нужны только компонентов монтажных чертежей на иностранном языке, чтобы в спецификации наименование отображалось на иностранном языке, но в КД оставалось на русском. Требует специального шаблона спецификации.
